...
struct MemoryEditor
{
    ...
    void DrawWindow(bool* _open, const char* title, void* mem_data, size_t mem_size, size_t base_display_addr = 0x0000)
    {
        Sizes s;
        ...
        Open = true;
        if (ImGui::Begin(title, _open, ImGuiWindowFlags_NoScrollbar))
        {
